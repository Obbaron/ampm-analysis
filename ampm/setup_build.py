...
def create_config(
    ...
    *,
    ...
    # Resolve each field: use override if given, otherwise auto-detect
    ...
    # Extract layer thickness from whichever CSV we're using
    layer_thickness = _extract_layer_thickness(csv_path)

    # Convert to relative paths from build_dir
    try:
